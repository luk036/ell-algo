...
Welcome to `ell-algo` contributor's guide.
...
If you experience bugs or general issues with `ell-algo`, please have a look
...
You can help improve `ell-algo` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ell-algo` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ell-algo`'s files. While this mechanism can
...
```
conda create -n ell-algo python=3 six virtualenv pytest pytest-cov
conda activate ell-algo
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ell-algo.git
   cd ell-algo
   ```
...
5. Install [pre-commit]:
   ...
   `ell-algo` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ell-algo
[issue tracker]: https://github.com/<USERNAME>/ell-algo/issues
